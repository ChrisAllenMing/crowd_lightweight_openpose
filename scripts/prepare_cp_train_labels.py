...
if __name__ == '__main__':
    ...
    for annotation in data["annotations"]:
        if annotation["num_keypoints"] != 0:
            if annotation["id"] not in annotations_per_image_mapping:
                annotations_per_image_mapping[annotation["id"]] = [[], []]
            annotations_per_image_mapping[annotation["id"]][0].append(annotation)
