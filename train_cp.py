...
from datasets.crowdpose import CPTrainDataset
from datasets.transformations_cp import ConvertKeypoints, Scale, Rotate, CropPad, Flip
...
def train(prepared_train_labels, train_images_folder, num_refinement_stages, base_lr, batch_size, batches_per_iter,
    ...
    sigma = 7
    path_thickness = 1
    dataset = CPTrainDataset(prepared_train_labels, train_images_folder,
