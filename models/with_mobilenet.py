...
class PoseEstimationWithMobileNet(nn.Module):
    def __init__(self, num_refinement_stages=1, num_channels=128, num_heatmaps=15, num_pafs=26):
        super().__init__()
...
class PoseEstimationWithMobileNet_new(nn.Module):
    def __init__(self, cfg, num_refinement_stages=1, num_channels=128, num_heatmaps=15, num_pafs=26):
        super().__init__()
